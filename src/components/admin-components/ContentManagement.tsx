import { AboutContent, SocialLinks } from '@/types/admin.types'
...
export default function ContentManagement({ aboutContent, setAboutContent, saving, message, updateAbout }: ContentManagementProps) {
  return (
    <>
      {/* About Content */}
                  ...
                  <div
                    ...
                    onDrop={(e) => {
                      ...
                      if (draggedIndex !== -1 && draggedIndex !== index) {
                        ...
                        const newSocialLinks = Object.fromEntries(newSocialLinksArray) as unknown as SocialLinks
                        setAboutContent({
                          ...aboutContent,
