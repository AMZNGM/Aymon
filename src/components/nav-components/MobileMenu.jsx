...
export default function MobileMenu({ className, btnClassName }) {
  ...
  return (
    <div className={`${className}`}>
      ...
      <nav
        role="navigation"
        className="z-1000 fixed inset-0 overflow-hidden flex flex-col justify-center items-center gap-4 bg-main opacity-100 peer-checked:opacity-100 font-medium 2xl:text-[4dvw] text-5xl uppercase transition-all translate-y-full peer-checked:translate-y-0 duration-300 ease-in-out px-6 py-2 pointer-events-none peer-checked:pointer-events-auto"
      >
