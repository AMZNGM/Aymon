  ...
  return (
    <section ref={containerRef} className={`relative w-full text-bg mb-12 px-1 ${className}`}>
      ...
      {hasButton && (
        <Link
          href={'/work'}
          className="z-30 relative flex flex-col justify-center items-end w-fit opacity-45 hover:opacity-100 font-bold text-[2.2dvw] text-bg max-md:text-xl uppercase tracking-wide transition-opacity duration-300 ms-auto mt-12"
        >
          See more
          <ArrowRight />
        </Link>
