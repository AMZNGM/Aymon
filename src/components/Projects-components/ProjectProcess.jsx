    ...
    >
      <AnimIn className="h-full overflow-y-scroll flex flex-col justify-between gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          <div>
            <h3 className="font-mono font-semibold max-md:text-base text-lg mb-2">The Process</h3>
            <p className="font-medium text-bg/75 max-md:text-xs text-sm wrap-break-word leading-5 max-md:leading-[18px] tracking-tighter whitespace-pre-wrap">
              {project.process}
            </p>
          </div>

          <div>
            <h3 className="font-mono font-semibold max-md:text-base text-lg mb-2">The Impact</h3>
            <p className="font-medium text-bg/75 max-md:text-xs text-sm wrap-break-word leading-5 max-md:leading-[18px] tracking-tighter whitespace-pre-wrap">
              {project.impact}
            </p>
          </div>
        ...
        {project.media?.video?.url && (
          <div className="mt-4">
            <h3 className="font-mono font-semibold max-md:text-base text-lg mb-2">Project Video</h3>
            <a
