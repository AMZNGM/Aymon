    ...
    <div className={`relative overflow-hidden bg-sec rounded-2xl p-4 md:p-6 ${className}`}>
      <AnimIn className="h-full overflow-auto flex flex-col justify-between gap-4">
        <div className="flex flex-col gap-8 max-md:gap-6">
          ...
          <p className="font-medium text-bg/75 2xl:text-[1dvw] max-md:text-sm text-base wrap-break-word max-md:leading-5 max-2xl:leading-[22px] tracking-tighter whitespace-pre-wrap">
        ...
        <button
          ...
          className="w-full bg-bg/10 hover:bg-bg/30 rounded-xl outline-none font-medium text-bg/75 2xl:text-[1dvw] duration-100 px-4 py-2 cursor-pointer select-none"
        >
