export default function LoadingOverlay({ text = 'Loading...', para = '' }: { text?: string; para?: string }) {
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          ...
          .loading-orbit-container::before,
          .loading-orbit-container::after {
            content: '';
            position: absolute;
            height: var(--uib-dot-size);
          ...
          .loading-orbit-container::before {
            animation: loading-orbit var(--uib-speed) linear infinite;
          }

          .loading-orbit-container::after {
            animation: loading-orbit var(--uib-speed) linear calc(var(--uib-speed) / -2) infinite;
          }
