...
export default function Navbar() {
  return (
    <header className="fixed right-0 w-screen md:w-1/4 min-h-screen bg-text text-bg z-50 md:me-18 lg:me-12 xl:me-4 2xl:me-0">
      <div className="relative h-screen flex flex-col justify-between items-end max-md:items-center gap-4 pt-12 px-4">
